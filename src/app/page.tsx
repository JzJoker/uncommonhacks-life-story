...
import CroppedPhoto from "@/components/dashboard/BookFrame";
  ...
  return (
    <main className="min-h-svh bg-cream-50 flex flex-col items-center justify-center px-6 py-16 gap-10">
      {patients.length > 0 && (
        <header className="flex flex-col items-center gap-2 text-center">
          ...
          <p className="text-base font-light text-muted">
            Choose a life story to explore or contribute to.
          </p>
          ...
          {patients.map((p) => (
            ...
            >
              ...
              <span className="text-xs text-muted uppercase tracking-widest">
                {p.experience_mode === "self_paced"
                  ? "Self-paced"
                  : "Caregiver-guided"}
              </span>
              {p.notes && (
                <span className="text-sm font-light text-muted line-clamp-2">
                  {p.notes}
                </span>
              )}
            </Link>
      ...
      {isCaregiver && patients.length > 0 && (
        <Link href="/onboarding">
          <Button variant="default" className="uppercase tracking-[0.18em]">
            Add Another Patient
          </Button>
        </Link>
      )}
